...
```sql
CREATE DATABASE biocalc_db;
CREATE USER biocalc_user WITH PASSWORD 'your_password';
GRANT ALL PRIVILEGES ON DATABASE biocalc_db TO biocalc_user;
```
...
```env
DATABASE_URL=postgresql://biocalc_user:your_password@localhost:5432/biocalc_db
...
### 7. Popule o banco de dados com dados auxiliares
